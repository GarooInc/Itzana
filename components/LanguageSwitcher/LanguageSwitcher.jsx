  ...
  const handleChange = e => {
    ...
    return (
        <div className='fixed top-4 right-0 p-4 dropdown'>
          ...
          <select onChange={handleChange} value={currentLocale} tabIndex={0} className="dropdown-content card card-compact bg-lightgreen text-white z-[1] w-20 p-2 shadow">
