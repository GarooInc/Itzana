...
const ChatBubble = () => {
  return (
    <div className="fixed bottom-4 cursor-pointer">
      <a href="https://wa.me/5016101329" target="_blank" rel="noopener noreferrer">
        <div className="w-56 h-10 relative">
          <div className="w-56 h-9 left-[1px] top-[2px] absolute bg-darkgray rounded-tl-2xl rounded-tr rounded-bl-2xl rounded-br">
          </div>
          ...
          <div className="w-10 h-10 left-0 top-0 absolute bg-darkgray rounded-full shadow-inner"></div>
